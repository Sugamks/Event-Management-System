<html>
    ...
    <body style="background-color: lightgoldenrodyellow">
        <div class="container">
        <?php echo form_open('Users/ordpmc'); ?>
            <h1>Punam Mahal Convention Hall</h1>
            <h3>Kengeri</h3>
            <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="1500">
                <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__af7443e91995f2da63d058b13c395f2ed022d68d" class="d-block w-100 h-50" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__82ed01042a9f12b6be64f34ded359b665fa0b67b" class="d-block w-100 h-50" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__42e56ab7430f4e6d60cfdeb5db4759e853c372f0" class="d-block w-100 h-50" alt="...">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__c873d514cc4172d6361de9e8b8dcbbb6fc572105" class="d-block w-100 h-50" alt="...">
                </div>
            </div>
            ...
            <ul class="nav nav-pills nav-fill">
                ...
                <div class="modal-dialog">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__82ed01042a9f12b6be64f34ded359b665fa0b67b" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__42e56ab7430f4e6d60cfdeb5db4759e853c372f0" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__c873d514cc4172d6361de9e8b8dcbbb6fc572105" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__a9569439f348783bd0ebe59ed9312b47677c46bd" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__ad2e78b5a2e4fee9f7d3ef4ce2713fc2f79777ed" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__f7cfe41dab6a531790f117b09908a47ade35c042" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__e147c66e9847e08f2fa0ecb7880cd75f7c115684" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__cfcde83ee140b25b8ba10679769c1aa9dda56c40" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                            <img src="http://34.120.136.253/hall_media/hall_index_126/hall_pic__861769fab5f0497022cb2b8af418434760ccc2eb" class="d-block w-100" alt="...">
                            </div>
                        </div>
                ...
                <li class="nav-item">
                <a class="btn" data-bs-toggle="modal" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="modal fade" id="gmaps" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.703286365049!2d77.4806711146447!3d12.926782190885323!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae3edbd29dfa77%3A0x3f5dc65b147661d4!2sPunam%20Mahal!5e0!3m2!1sen!2sin!4v1642149055503!5m2!1sen!2sin" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                            </div>
                            <div class="modal-footer">
                            </div>
                            </div>
