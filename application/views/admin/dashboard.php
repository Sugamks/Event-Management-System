...
<body style="background-color: lightgoldenrodyellow">
    <div class="container">
        <h1>Aishwarya Creations Admin Page</h1>
                        ...
                        if($res==TRUE)
                        {
                            ...
                            if($rows>0)
                            {
                                while($rows=mysqli_fetch_assoc($res))
                                {
                                    ...
                                    <td><?php echo $date;?></td>
                                    <td><a href="http://localhost/mini/admin/delete?user_id=<?php echo $user_id;?>">Delete</a></td>
                                    </td>
                                    </tr>
                                    <?php
                        ...
                        if($res==TRUE)
                        {
                            ...
                            if($rows>0)
                            {
                                while($rows=mysqli_fetch_assoc($res))
                                {
                                    ...
                                    <td><a href="http://localhost/mini/admin/deleteo?user_id=<?php echo $user_id;?>">Delete</a></td>
